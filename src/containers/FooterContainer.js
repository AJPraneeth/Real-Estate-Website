  ...
  return (
    <Footer>
      <Footer.Container>
        <Footer.Content>
          <Footer.Item>
            <Footer.Title>Prime Home</Footer.Title>
            <Footer.Text>
              No.75, D.S. Senanayake Mawatha, Borella, Colombo-08, Sri Lanka
            </Footer.Text>
            <Footer.List>
              <Footer.ListItem>
              ...
              <Footer.ListItem>
                ...
                <Footer.Text>homeprime96@gmail.com</Footer.Text>
              </Footer.ListItem>
            </Footer.List>
          </Footer.Item>
          <Footer.Item>
      ...
      <Footer.Bottom>
        <Footer.Container>
          <Footer.Text>&copy; Prime Home. All Rights Reserved</Footer.Text>
        </Footer.Container>
      </Footer.Bottom>
    </Footer>
  );
